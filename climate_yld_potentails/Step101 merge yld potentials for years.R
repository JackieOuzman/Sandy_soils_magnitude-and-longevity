...
df1 <- read.csv(  paste0( path_saved_files,"/NewFront_YP_yr_decile_crop_long_site_",
                          site1, 
                         ".csv") )
df2 <- read.csv(  paste0( path_saved_files,"/NewFront_YP_yr_decile_crop_long_site_",
                          site2, 
                          ".csv") )
df3 <- read.csv(  paste0( path_saved_files,"/NewFront_YP_yr_decile_crop_long_site_",
                          site3, 
                          ".csv") )
df4 <- read.csv(  paste0( path_saved_files,"/NewFront_YP_yr_decile_crop_long_site_",
                          site4, 
                          ".csv") )

NewFront <- rbind(df1, df2, df3, df4)


write_csv(NewFront,
          paste0(path_saved_files,"/NewFront_YP_yr_decile_crop_long", "_multiple_sites", ".csv" ))
