...
path_saved_files <- file_path_input_data<-file.path("N:","sandy soils conference", "data", "climate_data","Forecast_ylds")
...
write_csv(df_plot_long,
          paste0(path_saved_files,"/Forecast_yld_long_format", "site_", site_selected, "_year_", year, ".csv" ))
```